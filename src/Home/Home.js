                ...
                <div id={first_half_layer} className='firsthalf'>
                  ...
                  c-47.8,0-91-19.4-122.3-50.7"></path>
                            <g id="Dots" className="dots-nav">
                                <g>
                                    <path className="dotsst dotsfill" style={{ fill: 'rgb(0, 146, 255)', opacity: '1' }} d="M88.8,75c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S88.1,75,88.8,75z"></path>
                                </g>
                                <g>
                                    <path className="dotsstro" style={{ opacity: '1', fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10' }} d="M88.8,75c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S90.9,75,88.2,75z"></path>
                                </g>
                            </g>
